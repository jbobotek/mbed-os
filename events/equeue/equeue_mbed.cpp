...
static void equeue_tick_init() {
    ...
    equeue_minutes = 0;
    Timer *ptrTimer = reinterpret_cast<Timer*>(equeue_timer);
    ptrTimer->start();
    Ticker *ptrTicker = reinterpret_cast<Ticker*>(equeue_ticker);
    ptrTicker->attach_us(equeue_tick_update, 1000 << 16);
